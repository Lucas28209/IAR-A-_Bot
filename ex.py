...
with open("localizações.txt") as f:
...
POS_FABRICAS = [
    FB_COR[0][0] * FB_COR[0][1],
    FB_COR[1][0] * FB_COR[1][1],
    FB_COR[2][0] * FB_COR[2][1],
    FB_COR[3][0] * FB_COR[3][1],
    FB_COR[4][0] * FB_COR[4][1]
]
...
class Adjacencia():
    ...
    def generateTools(self):
        for i in range(20):
            cord_x = random.randint(1,41)
            cord_y = random.randint(1,41)
            number_TMP = cord_x * cord_y
        ...
        for i in range(6):
            ...
            while number_TMP in POS_AUX or self.values[number_TMP] != 0:
                cord_x = random.randint(1,41)
                cord_y = random.randint(1,41)
                number_TMP = cord_x * cord_y
